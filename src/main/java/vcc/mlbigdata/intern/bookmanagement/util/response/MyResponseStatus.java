...
public class MyResponseStatus<E> {
    ...
    private E result;
    public E data; // ONLY FOR LOTUS USER

    private MyResponseStatus(ResponseBuilders<E> builder) {
    ...
    public static class ResponseBuilders<E> {
        ...
        public MyResponseStatus<E> build() {
            return new MyResponseStatus<>(this);
        }
